...
svmfit = svm(Region ~ logSize + logRange, data = oak, cost = 1, kernel = "linear", type = "C-classification")
```
...
table(svmfit$fitted,oak$Region)
...
svcfit = svm(goodMPG~.-mpg-name, data = Auto, kernel = "linear", cost = 1, type = "C-classification")
