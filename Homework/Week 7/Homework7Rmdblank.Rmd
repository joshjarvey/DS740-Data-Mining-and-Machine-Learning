...
The proportion of variation explained by the bagged model (76.03%) is much greater than that of the normal linear model (52.40%). Therefore it appears to be the better model. 
