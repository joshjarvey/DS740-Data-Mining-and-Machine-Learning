...
There does appear to be autocorrelation within the residuals for buoy 3. In reviewing the plot, there is a clear "wavy" pattern in the residuals and each subsequent residual seems to be influenced by the previous. This would make sense because the way weather patterns work, where air temperature does not change every single day to something drastically different (for the most part). 
